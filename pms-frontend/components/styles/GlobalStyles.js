...
const GlobalStyles = createGlobalStyle`
  *, *:before, *:after {
  ...
  .header-notifications .ant-spin-container::-webkit-scrollbar {
    width: 4px;
  }
  .header-notifications .ant-spin-container::-webkit-scrollbar-track  {
    background: #f1f1f1; 
  }
  .header-notifications .ant-spin-container::-webkit-scrollbar-thumb {
    background: #888; 
  }
  .header-notifications .ant-spin-container::-webkit-scrollbar {
