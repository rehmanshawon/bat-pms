      ...
      >
        <Menu mode="horizontal">
          ...
          <Menu.Item
            ...
            style={{
              width: "300px",
              backgroundImage: "linear-gradient(to right, #004578 , #0078D4)",
            }}
          >
            <Link href="/">
              <a className="brand">
                <h1 style={{ color: "white" }}>BAT PMS</h1>
              </a>
            </Link>
          </Menu.Item>
                    ...
                    modules.map((module) => {
                      return (
                        <Menu.Item key={module.module_id}>
                          <Link href="#">
                            <a id={module.module_id} onClick={moduleChanger}>
                              {module.module_name}
                            </a>
                          </Link>
                        </Menu.Item>
                          ...
                          <small>
                            ...
                            {item.status !== "Seen" && (
                              <Tooltip title="Mark as Seen">
                                <i
                                  onClick={() => {
                                    markAsRead(String(item.event_action_id));
                                  }}
